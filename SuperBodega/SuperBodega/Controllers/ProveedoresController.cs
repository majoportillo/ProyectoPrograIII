...
namespace SuperBodega.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(SuperBodegaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Telefono")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Telefono")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
